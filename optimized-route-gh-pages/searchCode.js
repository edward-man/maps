...
function initMap() {
    ...
    map = new google.maps.Map(document.getElementById('map'), {
        center: {lat: 22.4513604, lng: 114.1618337}, //initially centered in the middle of the US, quickly replaced with current location
        zoom: 12
//        mapTypeId: google.maps.MapTypeId.ROADMAPs
    ...
    // https://www.outsystems.com/forums/discussion/26438/change-route-color-and-marker-on-google-map-direction/
    ...
    var searchBox0 = new google.maps.places.SearchBox($(`<input type="text">`).val("Fanling")[0]);
    ...
    console.log('sb no bound', searchBox0);
...
//        console.log(JSON.stringify(start)); //print in JSON format
    ...
    // var starting = document.getElementById("loc1")
    // starting.value = ;
...
function setMarker(n, plc) { //sets markers[n] to the latlng object loc, creates a new marker if it doesn't exist
    ...
    console.log(plc.geometry.location)
...
let $loc1 = $('#loc1')
// $loc1.val("Hung Hing Off-Set Printing Ltd.")
$loc1.trigger(jQuery.Event("keypress", {which: 49}));